 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: r_main.c,v 1.19 1999/10/12 13:01:14 cphipps Exp $
 *
...
static const char rcsid[] = "$Id: r_main.c,v 1.19 1999/10/12 13:01:14 cphipps Exp $";
...
{               
  ...
  //3d offset for right eye
  if (viewangleoffset > 0)
  {
    viewx -= MY3D_EYE * viewsin;
    viewy += MY3D_EYE * viewcos;
  }  
...
// R_RenderView
//
void R_RenderPlayerView (player_t* player,int rightframe)
{ 
  int temp;
