 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: r_things.c,v 1.10 1999/10/17 09:35:14 cphipps Exp $
 *
...
static const char
rcsid[] = "$Id: r_things.c,v 1.10 1999/10/17 09:35:14 cphipps Exp $";
...
void R_DrawMasked(void)
{
  ...
  // ...when weapon is not being drawn
  M_Drawer();
