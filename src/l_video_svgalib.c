 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: l_video_svgalib.c,v 1.20 1999/10/18 13:44:47 cphipps Exp $
 *
...
#ifndef lint
static const char 
rcsid[] = "$Id: l_video_svgalib.c,v 1.20 1999/10/18 13:44:47 cphipps Exp $";
#endif /* lint */
...
void I_SetPalette (int pal)
{
  ...
  if (!palette || (cachedgamma != usegamma)) {
    ...
    byte *playpal = W_CacheLumpNum(lump);
    register int *p;
    register int  count;
