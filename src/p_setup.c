 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: p_setup.c,v 1.13 1999/10/12 13:01:13 cphipps Exp $
 *
...
static const char
rcsid[] = "$Id: p_setup.c,v 1.13 1999/10/12 13:01:13 cphipps Exp $";
...
static void P_LoadSegs (int lump)
{
  int  i;
  const byte *data; // cph - const
  byte *vertchanged = Z_Calloc(numvertexes,sizeof(byte),PU_LEVEL,0); // phares 10/4/98
