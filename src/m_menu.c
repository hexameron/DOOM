 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: m_menu.c,v 1.21 1999/10/12 13:01:12 cphipps Exp $
 *
...
static const char
rcsid[] = "$Id: m_menu.c,v 1.21 1999/10/12 13:01:12 cphipps Exp $";
...
static void M_DrawBackground(const char* patchname)
{
  int     x,y;
  byte*   back_src;
  byte*   back_dest;
  ...
  // killough 4/17/98: 
  back_src = W_CacheLumpNum(firstflat+R_FlatNumForName(patchname));
  ...
  // cph - free the data
  W_UnlockLumpNum(firstflat+R_FlatNumForName(patchname));
}
