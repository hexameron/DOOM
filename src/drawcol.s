...
//-----------------------------------------------------------------------------
//
// $Id: drawcol.s,v 1.11 1999/10/12 13:04:17 cphipps Exp $
//
...
//================
 ...
 .text
 .align 16
 R_DrawColumn_Highres_NoWrap:	// cph - just to separate its profiling stats
7:				
; movl dc_iscale, %ecx
 movl %edi,%ecx		
...
R_DrawColumn_Highres_128:	// cph - just to separate its profiling stats
7:				
; movl dc_iscale, %ecx
 movl %edi,%ecx		
 movl SCREENWIDTH, %edi
