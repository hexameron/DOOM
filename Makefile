...
pkglibexecdir = $(libexecdir)/lxdoom
...
X_LIBS = 
X_PRE_LIBS = 
abs_builddir = /usr/src/DOOM
abs_srcdir = /usr/src/DOOM
abs_top_builddir = /usr/src/DOOM
abs_top_srcdir = /usr/src/DOOM
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /usr/src/DOOM/install-sh
